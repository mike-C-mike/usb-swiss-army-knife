...
- Unsigned Windows pre-release build.
...
- CSV files are the authoritative editable lists for v0.1.8.
...
## v0.2.0 download/install infrastructure

Download/install queue files are generated for planning only. Automatic downloads and installer execution are intentionally disabled until direct URLs, licensing, hashes, safety checks, and per-tool behavior are reviewed.
