...
```powershell
.\release\UsbSwissArmyKnife-v0.1.5-unsigned\UsbSwissArmyKnife.exe
```
...
If you extracted the build kit directly into your repository root, do **not** `cd` into a nested `usb_swiss_army_knife_v0_1_5_launcher_debug_release` folder. Just run:
